...
class MatchOverviewPlayerAdapter :
    ...
    private fun setItems(player: Players, binding: MatchOverviewItemBinding) {
        var item: ItemResult
        if (player.item0 != 0) {
            item = ConstData.items.first { it.id == player.item0 }
        ...
        if (player.item1 != 0) {
            item = ConstData.items.first { it.id == player.item1 }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
        ...
        if (player.item2 != 0) {
            item = ConstData.items.first { it.id == player.item2 }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
        ...
        if (player.item3 != 0) {
            item = ConstData.items.first { it.id == player.item3 }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
        ...
        if (player.item4 != 0) {
            item = ConstData.items.first { it.id == player.item4 }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
        ...
        if (player.item5 != 0) {
            item = ConstData.items.first { it.id == player.item5 }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
        ...
        if (player.itemNeutral != 0) {
            item = ConstData.items.first { it.id == player.itemNeutral }
            Glide.with(binding.root)
                .load("${URL}${item.img}")
                .apply(requestOptions())
